...
@section('title','E-Clothes || HOME PAGE')
                    ...
                    @foreach($product_lists as $product)
                        ...
                        <div class="single-product">
                            ...
                            <div class="product-content">
                                <h3><a href="{{route('product-detail',$product->slug)}}">{{$product->title}}</a></h3>
                                <div class="product-price">
                                    <span class="old">KSh{{number_format($product->price,2)}}</span>
                                    @php 
                                    $after_discount=($product->price-($product->price*$product->discount)/100)
                                    @endphp
                                    <span>KSh{{number_format($after_discount,2)}}</span>
                            ...
                            <div class="single-list">
                                ...
                                <div class="col-lg-6 col-md-6 col-12 no-padding">
                                    <div class="content">
                                        ...
                                        <p class="price with-discount">KSh{{number_format($product->discount,2)}}</p>
                                    </div>
                                </div>
                                </div>
                            </div>
                        ...
                        <div class="content">
                            <div class="heading-block">
                                ...
                                @php 
                                    $after_discount=($product->price-($product->price*$product->discount)/100)
                                @endphp
                                <h1 class="price">KSh{{number_format($after_discount)}} <s>KSh{{number_format($data->price)}}</s></h1>
