                                   ...
                                   <div class="col-lg-6 col-md-6 col-12">
                                       <div class="form-group">
                                           ...
                                           <select name="location" id="country">
                                               <option value="TW">CBD</option>
                                               <option value="WT">Westlands</option>
                                               <option value="SB">South B</option>
                                               <option value="SC">South C</option>
                                               <option value="RO">Roysambu</option>
                                               <option value="KW">Kahawa West</option>
                                               <option value="RI">Ruiru</option>
                                               <option value="KI">Kitisuru</option>
                                               <option value="RA">Ruaka</option>
                                               <option value="NG">Ngara</option>
                                               <option value="LA">Lavington</option>
                                               <option value="KI">Kileleshwa</option>
                                           </select>
                                       </div>
                                   </div> 
