...
@section('title','E-CLOTHES || DASHBOARD')
          ...
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                ...
                <div class="h5 mb-0 font-weight-bold text-white">{{\App\Models\Post::countActivePost()}}</div>
              </div>
              <div class="col-auto">
                    ...
                    tooltips: {
                      ...
                      callbacks: {
                        label: function(tooltipItem, chart) {
                          ...
                          return datasetLabel + ': sh' + number_format(tooltipItem.yLabel);
                        }
                      }
                    }
                  }
